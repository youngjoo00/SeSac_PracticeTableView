...
extension DetailCityInfoViewController {
    ...
    func configureTableView() {
        ...
        let detailXib = UINib(nibName: DetailCityInfoTableViewCell.identifier, bundle: nil)
        detailCityInfoTableView.register(detailXib, forCellReuseIdentifier: DetailCityInfoTableViewCell.identifier)
        let advertiseXib = UINib(nibName: AdvertiseTableViewCell.identifier, bundle: nil)
        detailCityInfoTableView.register(advertiseXib, forCellReuseIdentifier: AdvertiseTableViewCell.identifier)
    }
